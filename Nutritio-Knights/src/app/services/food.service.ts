...
export class FoodService {
  ...
  getFood(id:number|string): Promise<Food> {
    const url = 'http://testing-env-1.eba-ve96qwy6.us-east-1.elasticbeanstalk.com/nutritioknights/foods';
  ...
  searchFood(query:string): Promise<FoodSearchResult>{
    const url = 'http://testing-env-1.eba-ve96qwy6.us-east-1.elasticbeanstalk.com/nutritioknights/foods/search';
  let queryParams = new HttpParams();
